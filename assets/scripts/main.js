...
// mouse overs for bgs
document.getElementById('got-link').addEventListener('mouseover', () => {
  document.querySelector('body').style.backgroundColor = '#e0df96';
  document.getElementById('got-image').style.opacity = '1';
}, false);
document.getElementById('got-link').addEventListener('mouseout', () => {
  if (clicked === false) {
...
// star wars game
document.getElementById('sw-link').addEventListener('mouseover', () => {
  document.querySelector('body').style.backgroundColor = '#b0cdfc';
  document.getElementById('sw-image').style.opacity = '1';
}, false);
document.getElementById('sw-link').addEventListener('mouseout', () => {
  if (clicked === false) {
...
// tsf
document.getElementById('tsf-link').addEventListener('mouseover', () => {
  document.querySelector('body').style.backgroundColor = '#fc3835';
  document.getElementById('tsf-image').style.opacity = '1';
}, false);
document.getElementById('tsf-link').addEventListener('mouseout', () => {
  if (clicked === false) {
...
// star wars game
document.getElementById('wgg-link').addEventListener('mouseover', () => {
  document.querySelector('body').style.backgroundColor = '#4a8de0';
  document.getElementById('wgg-image').style.opacity = '1';
}, false);
document.getElementById('wgg-link').addEventListener('mouseout', () => {
  if (clicked === false) {
...
$(document).on('click', '#about-link', () => {
  $('.about-me').css({
    left: '0',
  });
});

$(document).on('click', '#back-to-home', () => {
  $('.about-me').css({
    left: '-100%',
  });
});
...
$(document).on('click', '#linkedin-icon', () => {
...
$(document).on('click', '#back-to-home-2', () => {
  clicked = false;
  $('.project-links').css({
    display: 'block',
  });
